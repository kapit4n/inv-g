...
function buildMockData(theme: string): DataMap {
  ...
  d["get_app_settings"] = (a: any) => [
    { id: 1, category: "general", key: "store_name", value: "InventoryGear", settingType: "string", description: "Nombre del negocio", isSystem: true, sortOrder: 1, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 2, category: "general", key: "business_type", value: "auto_parts", settingType: "select", description: "Tipo de negocio", options: JSON.stringify(["auto_parts", "tire_shop", "general_store"]), isSystem: true, sortOrder: 2, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 3, category: "regional", key: "language", value: "es", settingType: "select", description: "Idioma de la aplicación", options: JSON.stringify(["es", "en"]), isSystem: true, sortOrder: 3, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 4, category: "regional", key: "currency", value: "MXN", settingType: "select", description: "Moneda predeterminada", options: JSON.stringify(["MXN", "USD", "EUR"]), isSystem: true, sortOrder: 4, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 5, category: "regional", key: "date_format", value: "dd/MM/yyyy", settingType: "select", description: "Formato de fecha", options: JSON.stringify(["dd/MM/yyyy", "MM/dd/yyyy", "yyyy-MM-dd"]), isSystem: true, sortOrder: 5, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 6, category: "sales", key: "enable_pos", value: "true", settingType: "boolean", description: "Habilitar punto de venta", isSystem: true, sortOrder: 6, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 7, category: "sales", key: "tax_rate", value: "16", settingType: "number", description: "Tasa de impuesto (%)", validation: JSON.stringify({ min: 0, max: 100 }), isSystem: true, sortOrder: 7, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 8, category: "inventory", key: "low_stock_threshold", value: "10", settingType: "number", description: "Umbral de stock bajo", isSystem: true, sortOrder: 8, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 9, category: "inventory", key: "default_warehouse_id", value: "1", settingType: "number", description: "Almacén predeterminado", isSystem: true, sortOrder: 9, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 10, category: "security", key: "session_timeout_minutes", value: "480", settingType: "number", description: "Tiempo de sesión (minutos)", isSystem: true, sortOrder: 10, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 11, category: "security", key: "max_login_attempts", value: "5", settingType: "number", description: "Intentos máximos de inicio de sesión", isSystem: true, sortOrder: 11, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 12, category: "security", key: "password_min_length", value: "8", settingType: "number", description: "Longitud mínima de contraseña", isSystem: true, sortOrder: 12, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 13, category: "printing", key: "receipt_width_mm", value: "80", settingType: "number", description: "Ancho del recibo (mm)", isSystem: true, sortOrder: 13, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 14, category: "printing", key: "default_printer_id", value: "1", settingType: "number", description: "Impresora predeterminada", isSystem: true, sortOrder: 14, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 15, category: "backup", key: "auto_backup_enabled", value: "true", settingType: "boolean", description: "Respaldo automático habilitado", isSystem: true, sortOrder: 15, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 16, category: "backup", key: "auto_backup_interval_hours", value: "24", settingType: "number", description: "Intervalo de respaldo (horas)", isSystem: true, sortOrder: 16, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 17, category: "general", key: "items_per_page", value: "25", settingType: "number", description: "Elementos por página", isSystem: true, sortOrder: 17, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 18, category: "sales", key: "enable_credit", value: "true", settingType: "boolean", description: "Habilitar ventas a crédito", isSystem: true, sortOrder: 18, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 19, category: "sales", key: "invoice_footer", value: "Gracias por su compra", settingType: "string", description: "Pie de factura", isSystem: false, sortOrder: 19, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 20, category: "email", key: "smtp_host", value: "smtp.example.com", settingType: "string", description: "Servidor SMTP", isSystem: false, sortOrder: 20, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 21, category: "email", key: "smtp_port", value: "587", settingType: "number", description: "Puerto SMTP", isSystem: false, sortOrder: 21, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 22, category: "regional", key: "default_country", value: "México", settingType: "string", description: "País predeterminado", isSystem: false, sortOrder: 22, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 23, category: "regional", key: "default_city", value: "Ciudad de México", settingType: "string", description: "Ciudad predeterminada", isSystem: false, sortOrder: 23, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
    { id: 24, category: "sales", key: "enable_inventory", value: "true", settingType: "boolean", description: "Habilitar control de inventario", isSystem: true, sortOrder: 24, createdAt: "2025-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
  ]
  d["get_setting_categories"] = () => [
    { category: "general", count: 3 },
    { category: "regional", count: 5 },
    { category: "sales", count: 4 },
    { category: "inventory", count: 2 },
    { category: "security", count: 3 },
    { category: "printing", count: 2 },
    { category: "backup", count: 2 },
