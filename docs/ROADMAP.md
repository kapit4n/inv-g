...
| 17 | Windows Installer & 1.0.0 Release Packaging | ✅ | `bf64f43`, `PENDING` |
...
producción, y CI en Windows. Ver `docs/progress/MILESTONE_17.md` y
...
| 3 | Global search + command palette | 🔴 Critical | ✅ TASK 09 (command palette) |
